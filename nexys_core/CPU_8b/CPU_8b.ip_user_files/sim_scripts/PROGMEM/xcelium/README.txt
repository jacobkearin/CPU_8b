...
#
# Generated by export_simulation on Fri May 12 17:03:18 -0500 2023
#
################################################################################
...
'-reset_run' switch to the './PROGMEM.sh' script.

./PROGMEM.sh -reset_run
...
./PROGMEM.sh -noclean_files

For more information on the script, please type './PROGMEM.sh -help'.
