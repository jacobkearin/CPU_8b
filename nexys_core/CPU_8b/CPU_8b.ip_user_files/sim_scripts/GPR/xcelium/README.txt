...
#
# Generated by export_simulation on Thu May 11 12:42:13 -0500 2023
#
################################################################################
...
'-reset_run' switch to the './GPR.sh' script.
...
./GPR.sh -noclean_files

For more information on the script, please type './GPR.sh -help'.
