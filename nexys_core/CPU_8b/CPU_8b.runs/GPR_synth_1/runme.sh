...
HD_PWD='C:/Users/keajacm/Documents/repositories/CPU_8b/nexys_core/CPU_8b/CPU_8b.runs/GPR_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GPR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GPR.tcl
