...
HD_PWD='C:/Users/keajacm/Documents/repositories/CPU_8b/nexys_core/CPU_8b/CPU_8b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_core.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nexys_core.tcl -notrace
